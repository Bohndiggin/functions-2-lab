...
// CODE HERE
const totalPopulation = populations.reduce(function(accumalator, currentVal) {
...
const bobsTotal = purchases.filter(element => element.owner === "Bob").reduce((accumalator, currentVal) => accumalator + currentVal.price, 0)
