...
uniq(names, function(uniqArr){
  console.log(`The new names array with all the dupliciate items removed is ${uniqArr}`)
})
...
each(names, function(element, index){
  console.log(`The item index at ${index} is ${element}`)
})
